describe('user flow for passwords page', () => {
    ...
    it ('First check there are no passwords', async() => {
        const numPasswords = await page.$$eval('password-holder-card', (npassword) => {
    ...
    it ('Add a new password', async() => {
        ...
        await page.click('body > div.bg-dark.p-5.rounded-lg.m-3 > div.input-group.create-button-div > span > button');
    ...
    it ('Check username', async () => {
        ...
        // grab username
        const username = await page.$eval('#insert-username-modal',el => el.innerHTML);
    ...
    it ('Check password', async () => {
        ...
        await page.waitForSelector('#info-modal');
        // grab password
        const password = await page.$eval('#insert-password-modal',el => el.innerHTML);
